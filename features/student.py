...
class StudentFeatures(FlaskApp):
    ...
    def enroll_course(self, course_id):
        ...
        query_db('INSERT INTO peserta_has_kursus (id_peserta, id_kursus) VALUES (?, ?)', (student_id, course_id))
    ...
    def add_endpoints_student(self):
        ...
        self.add_endpoint('/student/enroll/<int:course_id>', 'enroll_course', self.enroll_course, methods=['POST'])
